...
const fourText = document.querySelector(".bottom-content .text-content:nth-of-type(4)");
const fiveText = document.querySelector(".bottom-content .text-content:nth-of-type(5)");
